...
export type FlowDefinitionFieldsFragment = { readonly id: string, readonly companyId: number | null, readonly documentType: Types.FlowDocumentType, readonly name: string, readonly version: number, readonly state: Types.FlowDefinitionState, readonly initialStatusId: string, readonly statuses: ReadonlyArray<{ readonly id: string, readonly name: string, readonly kind: Types.FlowStatusKind, readonly editableActions: ReadonlyArray<{ readonly action: Types.FlowEditableAction, readonly allowedRoles: ReadonlyArray<string> }>, readonly approval: { readonly allowSelfApproval: boolean, readonly approvedTransitionId: string, readonly rejectedTransitionId: string, readonly rules: ReadonlyArray<{ readonly id: string, readonly minAmount: number | null, readonly approvers: ReadonlyArray<{ readonly type: string, readonly userId: number | null, readonly roleId: string | null }> }> } | null }>, readonly transitions: ReadonlyArray<{ readonly id: string, readonly label: string, readonly fromStatusId: string, readonly toStatusId: string, readonly allowedRoles: ReadonlyArray<string>, readonly requiresComment: boolean | null, readonly sortOrder: string }> };

export type FlowRuntimeStateFieldsFragment = { readonly documentId: number, readonly documentType: Types.FlowDocumentType, readonly flowId: string, readonly flowVersion: number, readonly currentStatus: { readonly id: string, readonly name: string, readonly kind: Types.FlowStatusKind, readonly editableActions: ReadonlyArray<{ readonly action: Types.FlowEditableAction, readonly allowedRoles: ReadonlyArray<string> }>, readonly approval: { readonly allowSelfApproval: boolean, readonly approvedTransitionId: string, readonly rejectedTransitionId: string, readonly rules: ReadonlyArray<{ readonly id: string, readonly minAmount: number | null, readonly approvers: ReadonlyArray<{ readonly type: string, readonly userId: number | null, readonly roleId: string | null }> }> } | null }, readonly editPolicy: { readonly editableActions: ReadonlyArray<Types.FlowEditableAction>, readonly editableItemIds: ReadonlyArray<number>, readonly blockedActions: ReadonlyArray<{ readonly action: Types.FlowEditableAction, readonly reason: string }> }, readonly availableTransitions: ReadonlyArray<{ readonly id: string, readonly label: string, readonly toStatusId: string, readonly toStatusName: string }>, readonly blockedTransitions: ReadonlyArray<{ readonly id: string, readonly label: string, readonly reason: string }>, readonly pendingApproval: { readonly occurrenceId: string, readonly statusId: string, readonly approvalRuleId: string, readonly recordedApprovals: number, readonly canCurrentUserApprove: boolean, readonly canCurrentUserReject: boolean } | null };
